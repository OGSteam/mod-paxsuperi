...
include MOD_ROOT_CORE_PAX . 'Helper.php';
...
if (! isset($GLOBALS['pax_container'])) {
    ...
    $GLOBALS['pax_container']->singleton(SettingInterface::class, static fn () => Setting::getInstance());
    $GLOBALS['pax_container']->singleton(Setting::class, static fn ($c) => $c->make(SettingInterface::class));
}
...
if (! isset($GLOBALS['pax_logger'])) {
    ...
    $GLOBALS['pax_container']->singleton(LoggerInterface::class, static fn () => $GLOBALS['pax_logger']);
    $GLOBALS['pax_container']->singleton(Pax_Logger::class, static fn () => $GLOBALS['pax_logger']);

    $GLOBALS['pax_container']->bind(XmlManagerInterface::class, static fn ($c) => new XmlManager(
